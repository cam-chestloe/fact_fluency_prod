defmodule FactFluencyWeb.StudentControllerTest do
  use FactFluencyWeb.ConnCase

  alias FactFluency.Students

  @create_attrs %{duplicate_id: "some duplicate_id", first_name: "some first_name", last_initial: "some last_initial", timestamps: "some timestamps"}
  ...
  describe "update student" do
    ...
    test "redirects when data is valid", %{conn: conn, student: student} do
      ...
      assert html_response(conn, 200) =~ "some updated duplicate_id"
    end

defmodule FactFluency.TeachersTest do
  ...
  describe "teachers" do
    ...
    @valid_attrs %{first_name: "some first_name", last_name: "some last_name", timestamps: "some timestamps"}
    ...
    test "create_teacher/1 with valid data creates a teacher" do
      ...
      assert teacher.timestamps == "some timestamps"
    end
    ...
    test "update_teacher/2 with valid data updates the teacher" do
      ...
      assert teacher.timestamps == "some updated timestamps"
    end
